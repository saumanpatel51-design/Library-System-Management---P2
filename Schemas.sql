...
--Task 6: Create Summary Tables: Used SELECT QUERY to generate new tables based on query results - each book and total book_issued_cnt**
SELECT b.isbn, 
       b.book_title, 
...
SELECT * from members
WHERE reg_date  >= DATEADD(DAY, -180, GETDATE()); --	•	DATEADD(DAY, -180, GETDATE()) → subtracts 180 days from today.
